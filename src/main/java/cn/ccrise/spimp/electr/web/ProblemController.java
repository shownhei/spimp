...
import cn.ccrise.spimp.electr.service.ProblemService;
...
public class ProblemController {
	...
	@RequestMapping(value = "/electr/maintenance/problems/{id}", method = RequestMethod.DELETE)
	@ResponseBody
	public Response delete(@PathVariable long id) {
		return new Response(problemService.delete(id));
	}

	@RequestMapping(value = "/electr/maintenance/problems/export-excel", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/electr/maintenance/problems/{id}", method = RequestMethod.GET)
	@ResponseBody
	public Response get(@PathVariable long id) {
		return new Response(problemService.get(id));
	}

	@RequestMapping(value = "/electr/maintenance/problem", method = RequestMethod.GET)
	public String index() {
		return "electr/maintenance/problem/index";
	}

	@RequestMapping(value = "/electr/maintenance/problems", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/electr/maintenance/problems", method = RequestMethod.POST)
	@ResponseBody
	public Response save(@Valid @RequestBody Problem problem) {
		return new Response(problemService.save(problem));
	}

	@RequestMapping(value = "/electr/maintenance/problems/{id}", method = RequestMethod.PUT)
	@ResponseBody
