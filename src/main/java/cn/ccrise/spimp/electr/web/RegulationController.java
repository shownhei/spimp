...
import cn.ccrise.spimp.electr.service.RegulationService;
...
public class RegulationController {
	...
	@RequestMapping(value = "/electr/regulations/{id}", method = RequestMethod.DELETE)
	@ResponseBody
	...
	@RequestMapping(value = "/electr/regulations/export-excel", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/electr/regulations/{id}", method = RequestMethod.GET)
	@ResponseBody
	public Response get(@PathVariable long id) {
		return new Response(regulationService.get(id));
	}

	@RequestMapping(value = "/electr/regulation", method = RequestMethod.GET)
	public String index() {
		return "electr/regulation/index";
	}

	@RequestMapping(value = "/electr/regulations", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/electr/regulations", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/electr/regulations/{id}", method = RequestMethod.PUT)
	@ResponseBody
