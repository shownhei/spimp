...
public class InitErcsService {
	...
	public void initFourthLevelOperate() {
		...
		resourceEntityServiceImpl.saveMenuResource("二维展示", "/ercs/indicate-index/2d", indicate, "", 1);
		resourceEntityServiceImpl.saveMenuResource("三维展示", "/ercs/indicate-index/3d", indicate, "", 2);
