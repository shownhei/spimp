...
import cn.ccrise.spimp.spmi.car.service.MaintenanceTestingService;
...
public class MaintenanceTestingController {
	...
	@RequestMapping(value = "/car/maintenance/maintenance-testings/{id}", method = RequestMethod.DELETE)
	@ResponseBody
	...
	@RequestMapping(value = "/car/maintenance/maintenance-testing", method = RequestMethod.GET)
	public String index() {
		return "car/maintenance/maintenance-testing/index";
	}

	@RequestMapping(value = "/car/maintenance/maintenance-testings", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/car/maintenance/maintenance-testings", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/car/maintenance/maintenance-testings/{id}", method = RequestMethod.PUT)
	@ResponseBody
