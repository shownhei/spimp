...
import cn.ccrise.spimp.spmi.car.service.StockService;
...
public class StockController {
	...
	@RequestMapping(value = "/car/material/stocks/{id}", method = RequestMethod.DELETE)
	@ResponseBody
	public Response delete(@PathVariable long id) {
		return new Response(stockService.delete(id));
	}

	@RequestMapping(value = "/car/material/stocks/export-excel", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/car/material/stocks/{id}", method = RequestMethod.GET)
	@ResponseBody
	public Response get(@PathVariable long id) {
		return new Response(stockService.get(id));
	}

	@RequestMapping(value = "/car/material/stock", method = RequestMethod.GET)
	public String index() {
		return "car/material/stock/index";
	}

	@RequestMapping(value = "/car/material/stocks", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/car/material/stocks", method = RequestMethod.POST)
	@ResponseBody
	public Response save(@Valid @RequestBody Stock stock) {
		return new Response(stockService.save(stock));
	}

	@RequestMapping(value = "/car/material/stocks/{id}", method = RequestMethod.PUT)
	@ResponseBody
