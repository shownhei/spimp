...
public class DocumentController {
	...
	@ResponseBody
	public Response page(Page<Document> page, String office, String search, Long projectType, String documentName, String keyword, String startDate, String endDate) {
