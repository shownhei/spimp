...
public class InitService extends DataInitAbstractService {
	...
	public void initCustomSystemResource() {
		...
		resourceEntityServiceImpl.saveMenuResource("定期保养周期配置", "/electr/maintenance/regular-config", jddMaintenance,
				"", i++);
		resourceEntityServiceImpl.saveMenuResource("定期保养到期提醒", "/electr/maintenance/regular-remind", jddMaintenance,
				"", i++);
