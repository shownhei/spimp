...
public class InitService extends DataInitAbstractService {
    ...
    public void initCustomData() {
        ...
        // 岗位
        String posts[] = {"把钩工", "充电工", "见习维修工", "井底把钩工", "皮带维修工", "电钳工", "配电工", "送饭工", "清煤工", "维修工", "卫生清理工", "修道工", "35KV变电站配电工", "队勤（材料员）", "队勤（核算员）", "副绞司机", "机车司机", "空压司机", "皮带司机", "拖拉机司机", "主井皮带司机", "主提升司机", "主扇司机", "轨道运输", "锅炉化验", "地面供电系统", "井下运输系统", "主提升系统", "全面负责", "主井卫生", "主提升机头", "主提升机尾"};
