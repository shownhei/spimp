define(function(require, exports, module) {
	...
	var operateUri = '/spmi/car/materials-plan-details';
	...
	// 下拉列表初始化
	Utils.select.remote([ 'search_plan', 'create_plan', 'edit_plan' ], '/spmi/car/materials-planslist', 'id', 'planTitle', true, '材料计划');
	Utils.select.remote([ 'create-groupEntity'], '/system/groups', 'id', 'name');
	Utils.select.remote([ 'plan'], '/spmi/car/materials-planslist', 'id', 'planTitle'); 
