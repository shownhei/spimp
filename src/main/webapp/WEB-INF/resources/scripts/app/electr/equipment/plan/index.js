define(function(require, exports, module) {
	...
	var operateUri = '/electr/equipment/maintenance-plans';
	...
	// 下拉列表初始化
	Utils.select.remote([ 'search_project', 'create_project', 'edit_project' ], '/system/dictionaries?list=true&typeCode=equipment_maintenance_project', 'id',
			'itemName', true, '检修内容');
	...
	function validate(showType, model) {
		...
		if (model.standard === '') {
			errorMsg.push('请输入检修标准');
		}

		if (model.workDate === '') {
			errorMsg.push('请输入检查时间');
		}
	...
	function showDetail(data) {
		...
		object.project = object.project.itemName;
