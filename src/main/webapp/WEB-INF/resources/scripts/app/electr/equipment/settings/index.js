define(function(require, exports, module) {
	...
	var operateUri = '/electr/equipment/reminder-settings';
	...
	function validate(showType, model) {
		...
		if (model.expirationDate === '') {
			errorMsg.push('请输入到期时间');
		}

		if (model.daysEarly === '') {
			errorMsg.push('请输入提前天数');
		}

		if (model.daysEarly !== '' && !$.isNumeric(model.daysEarly)) {
			errorMsg.push('提前天数为数字格式');
		}
