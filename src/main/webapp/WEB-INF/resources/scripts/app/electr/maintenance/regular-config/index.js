define(function(require, exports, module) {
	...
	var operateUri = '/electr/maintenance/regular-configs';
	...
	function validate(showType, model) {
		...
		if (model.kilometres === '') {
			errorMsg.push('请输入公里数');
		}

		if (model.kilometres !== '' && !$.isNumeric(model.kilometres)) {
			errorMsg.push('公里数为数字格式');
		}
	...
	function showDetail(data) {
		...
		object.planGroup = object.planGroup.name;
