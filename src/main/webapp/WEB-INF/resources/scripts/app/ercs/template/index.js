define(function(require, exports, module) {
	...
	// 配置表格
	var defaultUrl = contextPath + '/ercs/emergency-plan-templates?orderBy=id&order=desc&pageSize=' + pageSize;
	var grid = new Grid({
	...
	$('#create-save').click(function() {
		...
		$.post('/ercs/emergency-plan-templates', JSON.stringify(object), function(data) {
			if (data.success) {
				grid.refresh();
	...
	$('#edit-save').click(function() {
		...
		var selectId = grid.selectedData('id');
		$.put('/ercs/emergency-plan-templates/' + selectId, JSON.stringify(object), function(data) {
			if (data.success) {
				grid.refresh();
	...
	$('#remove-save').click(function() {
		var selectId = grid.selectedData('id');
		$.del('/ercs/emergency-plan-templates/' + selectId, function(data) {
			grid.refresh();
