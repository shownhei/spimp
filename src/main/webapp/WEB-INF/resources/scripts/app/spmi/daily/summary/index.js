define(function(require, exports, module) {
	...
	Utils.select.remote([ 'create-category', 'edit-category' ], '/system/dictionaries?typeCode=summary_type&list=true', 'id', 'itemName');
	// 配置表格列
	var fields = [ {
		header : '文件名',
		name : 'name'
	...
	// 配置表格
	var defaultUrl = contextPath + '/spmi/daily/summaries?orderBy=id&order=desc&pageSize=' + pageSize;
	var grid = new Grid({
		parentNode : '#records',
		url : defaultUrl,
		model : {
	...
	$('#edit').click(function() {
		...
		$.get(contextPath + '/spmi/daily/summaries/' + selectId, function(data) {
