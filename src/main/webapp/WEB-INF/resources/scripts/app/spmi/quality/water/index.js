define(function(require, exports, module) {
	...
	$('#view-grade-record-table').height($(window).height() - 200 - 310);
	...
	$('#create-save').click(function() {
		...
		// 防治水 100 25
		// 防地压 100 10
		object.score = groupScores[1] * 0.15 + groupScores[2] * 0.25 + groupScores[3] * 0.25 + groupScores[4] * 0.25 + groupScores[5] * 0.1;
