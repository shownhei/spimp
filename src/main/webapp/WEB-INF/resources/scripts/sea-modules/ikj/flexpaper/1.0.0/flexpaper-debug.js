define("ikj/flexpaper/1.0.0/flexpaper-debug", [ "$-debug" ], function(require, exports, module) {
 ...
 */
    ...
    var FlexPaperViewerEmbedding = function(id, args) {
        ...
        flashembed(id, {
            //src						    : _jsDirectory+"../src/FlexPaperViewer.swf",
            src: config.src,
            version: [ 10, 0 ],
            ...
            Scale: config.Scale != null ? config.Scale : .8,
            ZoomTransition: config.ZoomTransition != null ? config.ZoomTransition : "easeOut",
            ZoomTime: config.ZoomTime != null ? config.ZoomTime : .5,
            ZoomInterval: config.ZoomInterval ? config.ZoomInterval : .2,
            FitPageOnLoad: config.FitPageOnLoad != null ? config.FitPageOnLoad : false,
            FitWidthOnLoad: config.FitWidthOnLoad != null ? config.FitWidthOnLoad : false,
            FullScreenAsMaxWindow: config.FullScreenAsMaxWindow != null ? config.FullScreenAsMaxWindow : false,
            ProgressiveLoading: config.ProgressiveLoading != null ? config.ProgressiveLoading : false,
            MinZoomSize: config.MinZoomSize != null ? config.MinZoomSize : .2,
            ...
            EnableCornerDragging: config.EnableCornerDragging != null ? config.EnableCornerDragging : true,
            // FlexPaper Zine parameter
 ...
 */
    var flashembed;
    (function() {
        var IE = document.all, URL = "http://www.adobe.com/go/getflashplayer", JQUERY = typeof jQuery == "function", RE = /(\d+)[^\d]+(\d+)[^\d]*(\d*)/, MOBILE = function() {
            try {
        ...
        var dispatchJQueryEvent = function(elementId, eventName, args) {
        ...
        flashembed = function(root, opts, conf) {
