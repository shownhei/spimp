...
<div class="tabbable" id="content">
	...
	<div class="tab-content" id="tab-content">
		<div id="tab1" class="tab-pane in active">
			<div class="row-fluid" id="row0">
				<div class="span6" id="col0_0">
					<div class="widget-header widget-header-flat widget-header-small">
						<i class="green icon-th-list"></i>视频信息<i
							class="blue icon-resize-full complex-button-resize"></i>
					</div>
						...
						<div class="widget-main" style="overflow-y: auto;">
							<c:forEach items="${CAMERA}" var="data">
								<div class="complex-video-wrapper">
									<object classid="clsid:ab1408a0-10f6-40ba-984d-074d7bdc3126"
										width="200" height="150" id="${data.ID}"></object>
				...
				<div class="span6" id="col0_1">
					<div class="widget-header widget-header-flat widget-header-small">
						<i class="green icon-th-list"></i>人员情况<i
							class="blue icon-resize-full complex-button-resize"></i>
					</div>
					<div class="widget-body complex-widget-body">
			...
			<div class="row-fluid" id="row1" style="margin-top: 10px;">
				<div class="span6" id="col1_0">
					<div class="widget-header widget-header-flat widget-header-small">
						<i class="green icon-th-list"></i>设备情况<i
							class="blue icon-resize-full complex-button-resize"></i>
					</div>
					<div class="widget-body complex-widget-body">
						<div class="widget-main complex-widget-main">
							<table class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<c:forEach items="${equipments}" var="data" varStatus="status">
										<tr>
				...
				<div class="span6" id="col1_1">
					<div class="widget-header widget-header-flat widget-header-small">
						<i class="green icon-th-list"></i>环境信息<i
							class="blue icon-resize-full complex-button-resize"></i>
					</div>
					<div class="widget-body complex-widget-body">
						<div class="widget-main complex-widget-main">
		...
		<div id="tab2" class="tab-pane">
			<div class="row-fluid">
				<div class="span12" id="col2_0" style="overflow: auto;">
					<table class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								<th>文档名称</th>
						...
						<tbody>
							<c:forEach items="${documents}" var="data" varStatus="status">
								<tr>
									<td><a href="javascript:void(0);" data-swf="${ data.attachment.swfPath}" data-id="${data.attachment.id}">${ data.documentName}</a></td>
									<td>${ data.uploadGroup.name}</td>
