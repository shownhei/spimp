...
<html>
<head>
<title>检修计划管理 - 山西王庄煤业数字矿山综合管理平台</title>
...
<body class="navbar-fixed">
	...
	<div id="create-modal" class="modal modal-lg hide">
		<div class="modal-header">
			...
			<h5 class="green">
				<i class="icon-plus-sign-alt"></i> 新建检修计划
			</h5>
		</div>
				...
				<div class="span12">
					<form id="create-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="project">检修内容</label>
							<div class="controls">
								<select id="create_project" name="project[id]"></select>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="content">检修内容</label>
							<div class="controls">
								<textarea id="create_content" name="content" rows=5></textarea>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="standard">检修标准</label>
							<div class="controls">
								<textarea id="create_standard" name="standard" rows=8></textarea>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="workDate">检查时间</label>
							<div class="controls">
				...
				<div class="span12">
					<form id="edit-form" class="form-horizontal" style="margin-bottom: 0px;">
						...
						<div class="control-group">
							<label class="control-label" for="standard">检修标准</label>
							<div class="controls">
								<textarea id="edit_standard" name="standard" rows=8></textarea>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="workDate">检查时间</label>
				...
				<div class="span12">
					<form id="detail-form" class="form-horizontal" style="margin-bottom: 0px;">
						...
						<div class="control-group">
							<label class="control-label" for="content">检修内容</label>
							<div class="controls">
								<textarea id="detail_content" name="content" rows=5 readonly="readonly"></textarea>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="standard">检修标准</label>
							<div class="controls">
								<textarea id="detail_standard" name="standard" rows=8 readonly="readonly"></textarea>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="workDate">检查时间</label>
	...
	<script type="text/javascript">
		seajs.use('${resources}/scripts/app/electr/equipment/plan/index');
	</script>
