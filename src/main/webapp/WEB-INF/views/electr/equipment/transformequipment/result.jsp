...
<ul class="nav nav-tabs">
	<li class="active" id="ReducerDeviceTab" elType="tab">
		<a data-toggle="tab" href="#ReducerDevice" elType="tab">
			<i class="green icon-home" elType="tab"></i> 减速机
		</a>
	</li>
	<li id="ElectromotorDeviceTab">
		<a data-toggle="tab" href="#ElectromotorDevice" elType="tab">
			<i class="green icon-list" elType="tab"></i> 电动机
		</a>
	</li>
	<li id="BrakeDeviceTab">
		<a data-toggle="tab" href="#BrakeDevice" elType="tab">
			<i class="green icon-list" elType="tab"></i> 制动器
		</a>
	</li>
	<li id="TensioningDeviceTab" elType="tab">
		<a data-toggle="tab" href="#TensioningDevice" elType="tab">
			<i class="green icon-list" elType="tab"></i> 拉紧装置
		</a>
	</li>
</ul>
		...
		<div class="row-fluid">
			<div class="span6">
				<button id="reducer_create" class="btn btn-small btn-success">
					...
					<span class="hidden-phone">添加</span>
				</button>
			</div>
						...
						<tbody>
							<c:forEach items="${tensioningDevices }" var="data">
								<tr class="grid-row page-report-table-tr">
									...
									<td>${data.productionDate}</td>
									<td>${data.producer}</td>
									<td dataType="showRemark" width=100>
										<div style="width: 100px; height: 20px; overflow: hidden; white-space: nowrap;">${data.techParameters}</div>
									</td>
									<td>
										<div class="visible-md  btn-group">
