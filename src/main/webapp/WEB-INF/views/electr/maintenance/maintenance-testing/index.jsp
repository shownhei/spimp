...
<body class="navbar-fixed">
			...
			<div class="page-toolbar">
				...
				<div class="nav-search">
					<form id="search-form" class="form-search" onsubmit="return false;">
						...
						<input name="search" type="text" style="height:15px;width:130px;font-size:12px;" placeholder="输入维修工...">
			...
			<div class="row-fluid">
				<div class="span12">
					<form id="create-form" class="form-horizontal" style="margin-bottom: 0px;">
						...
						<div class="control-group">
							<label class="control-label" for="miantainer">维修工</label>
							<div class="controls">
								<input id="create_miantainer" name="miantainer" type="text">
							</div>
						</div>
					</form>
				</div>
				...
				<div class="span12">
					<form id="edit-form" class="form-horizontal" style="margin-bottom: 0px;">
						...
						<div class="control-group">
							<label class="control-label" for="miantainer">维修工</label>
							<div class="controls">
								<input id="edit_miantainer" name="miantainer" type="text">
							</div>
						</div>
					</form>
				</div>
				...
				<div class="span12">
					<form id="detail-form" class="form-horizontal" style="margin-bottom: 0px;">
						...
						<div class="control-group">
							<label class="control-label" for="miantainer">维修工</label>
							<div class="controls">
								<input id="detail_miantainer" name="miantainer" type="text" readonly="readonly">
							</div>
						</div>
						<div class="control-group">
	...
	<script type="text/javascript">
		seajs.use('${resources}/scripts/app/electr/maintenance/maintenance-testing/index');
	</script>
