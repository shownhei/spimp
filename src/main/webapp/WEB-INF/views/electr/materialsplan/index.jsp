...
<body class="navbar-fixed">
			...
			<div class="page-toolbar">
				...
				<div class="nav-search">
					<form id="search-form" class="form-search" onsubmit="return false;">
						...
						<input name="search" type="text" style="height: 15px; width: 130px; font-size: 12px;" placeholder="输入计划名称...">
				...
				<div class="span12">
					<form id="create-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							...
							<div class="controls">
								<input type="datetime" placeholder="请选择" class="input-small" autocomplete="off" id="create_planDate" name="planDate">
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="create_planTitle" name="planTitle" type="text">
							</div>
						</div>
					</form>
				</div>
				...
				<div class="span12">
					<form id="edit-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="planDate">计划日期</label>
							<div class="controls">
								<input type="datetime" placeholder="请选择" class="input-small" autocomplete="off" id="edit_planDate" name="planDate">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="planGroup">单位</label>
							<div class="controls">
								<input id="edit_planGroup" name="planGroup" type="text">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="planTitle">计划名称</label>
							<div class="controls">
								<input id="edit_planTitle" name="planTitle" type="text">
							</div>
						</div>
					</form>
				</div>
				...
				<div class="span12">
					<form id="detail-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="planDate">计划日期</label>
							<div class="controls">
								<input id="detail_planDate" name="planDate" type="text" readonly="readonly">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="planGroup">单位</label>
						...
						<div class="control-group">
							<label class="control-label" for="planTitle">计划名称</label>
							<div class="controls">
								<input id="detail_planTitle" name="planTitle" type="text" readonly="readonly">
							</div>
						</div>
					</form>
				</div>
	...
	<script type="text/javascript">
		seajs.use('${resources}/scripts/app/spmi/electr/materialsplan/index');
	</script>
