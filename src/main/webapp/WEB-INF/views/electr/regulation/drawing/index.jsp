...
<html>
<head>
<title>工作安排管理 - 山西王庄煤业数字矿山综合管理平台</title>
...
<body class="navbar-fixed">
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<form id="create-file-form" action="/simpleupload" class="form-horizontal" style="margin-bottom: 0px;" method="post" enctype="multipart/form-data"
						target="acceptFrame">
						<div class="control-group">
							<label class="control-label span2" for="credential">图纸文件</label>
							<div class="controls">
	...
	<script type="text/javascript">
		seajs.use('${resources}/scripts/app/electr/regulation/drawing/index');
	</script>
