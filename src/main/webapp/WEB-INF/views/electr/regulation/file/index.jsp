...
<body class="navbar-fixed">
			...
			<div class="page-toolbar">
				...
				<div class="nav-search">
					<form id="search-form" class="form-search" onsubmit="return false;">
						...
						<input name="search" type="text" style="height: 15px; width: 130px; font-size: 12px;" placeholder="输入文档名称..."> <select id="search_fileType"
							name="fileType" style="height: 25px; width: 120px; font-size: 12px;"></select>
				...
				<div class="span12">
					<form id="create-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="fileTitle">文档名称</label>
							<div class="controls">
								<input id="create_fileTitle" name="fileTitle" type="text">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="fileType">制度类型</label>
							<div class="controls">
								<select id="create_fileType" name="fileType[id]"></select>
							</div>
						</div>
						<div class="control-group">
				...
				<div class="span12">
					<form id="edit-form" class="form-horizontal" style="margin-bottom: 0px;">
						...
						<div class="control-group">
							<label class="control-label" for="fileType">制度类型</label>
							<div class="controls">
								<select id="edit_fileType" name="fileType[id]"></select>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="uploadDate">上传日期</label>
				...
				<div class="span12">
					<form id="detail-form" class="form-horizontal" style="margin-bottom: 0px;">
						...
						<div class="control-group">
							<label class="control-label" for="fileType">制度类型</label>
							<div class="controls">
								<input id="detail_fileType" name="fileType" type="text" readonly="readonly">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="attachment">附件</label>
	...
	<script type="text/javascript">
		seajs.use('${resources}/scripts/app/electr/regulation/file/index');
	</script>
