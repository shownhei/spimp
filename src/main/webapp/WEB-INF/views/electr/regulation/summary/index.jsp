...
<html>
<head>
<title>每月总结 - 山西王庄煤业数字矿山综合管理平台</title>
...
<body class="navbar-fixed">
			...
			<div class="page-toolbar">
				...
				<div class="nav-search">
					<form id="search-form" class="form-search" onsubmit="return false;">
						...
						<select id="search_summaryType" name="summaryType" style="height: 25px; width: 120px; font-size: 12px;"></select>
				...
				<div class="span12">
					<form id="create-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="summaryTitle">材料名称</label>
							<div class="controls">
								<input id="create_summaryTitle" name="summaryTitle" type="text">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="summaryType">总结分类</label>
							<div class="controls">
								<select id="create_summaryType" name="summaryType[id]"></select>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="uploadDate">上传日期</label>
							<div class="controls">
								<input type="datetime" placeholder="请选择" class="input-small" autocomplete="off" id="create_uploadDate" name="uploadDate">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="summary">附件</label>
							<div class="controls">
								<input id="summary" readonly name="summary" type="text" class="span10" style="width: 350px;">
				...
				<div class="span12">
					<form id="edit-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="summaryTitle">材料名称</label>
							<div class="controls">
								<input id="edit_summaryTitle" name="summaryTitle" type="text">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="summaryType">总结分类</label>
							<div class="controls">
								<select id="edit_summaryType" name="summaryType[id]"></select>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="uploadDate">上传日期</label>
							<div class="controls">
								<input type="datetime" placeholder="请选择" class="input-small" autocomplete="off" id="edit_uploadDate" name="uploadDate">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="summary">附件</label>
				...
				<div class="span12">
					<form id="detail-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="summaryTitle">材料名称</label>
							<div class="controls">
								<input id="detail_summaryTitle" name="summaryTitle" type="text" readonly="readonly">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="summary">附件</label>
						...
						<div class="control-group">
							<label class="control-label" for="summaryType">总结分类</label>
							<div class="controls">
								<input id="detail_summaryType" name="summaryType" type="text" readonly="readonly">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="uploadDate">上传日期</label>
	...
	<script type="text/javascript">
		seajs.use('${resources}/scripts/app/electr/regulation/summary/index');
	</script>
