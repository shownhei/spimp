...
<body class="navbar-fixed">
				...
				<div class="span12">
					<form id="create-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							...
							<div class="controls">
								<input id="create_carCategory" name="carCategory" type="text">
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="create_carStatus" name="carStatus" type="number">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="engineSize">排气量</label>
							<div class="controls">
								<input id="create_engineSize" name="engineSize" type="number">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="engineNumber">发动机号</label>
							<div class="controls">
								<input id="create_engineNumber" name="engineNumber" type="number">
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="create_addDateTime" name="addDateTime" type="text">
							</div>
						</div>
					</form>
				</div>
				...
				<div class="span12">
					<form id="edit-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="carCategory">车辆类型</label>
							<div class="controls">
								<input id="edit_carCategory" name="carCategory" type="text">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="models">车辆型号</label>
						...
						<div class="control-group">
							<label class="control-label" for="carStatus">车辆状态</label>
							<div class="controls">
								<input id="edit_carStatus" name="carStatus" type="number">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="engineSize">排气量</label>
							<div class="controls">
								<input id="edit_engineSize" name="engineSize" type="number">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="engineNumber">发动机号</label>
							<div class="controls">
								<input id="edit_engineNumber" name="engineNumber" type="number">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="buyDate">购买日期</label>
						...
						<div class="control-group">
							<label class="control-label" for="addDateTime">记录时间</label>
							<div class="controls">
								<input id="edit_addDateTime" name="addDateTime" type="text">
							</div>
						</div>
					</form>
				</div>
	...
	<script type="text/javascript">
		seajs.use('${resources}/scripts/app/spmi/car/car/index');
	</script>
