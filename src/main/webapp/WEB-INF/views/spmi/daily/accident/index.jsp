...
<html>
<head>
<title>事故记录 - 山西王庄煤业数字矿山综合管理平台</title>
...
<body class="navbar-fixed">
	...
	<div class="main-container container-fluid">
		...
		<div class="main-content">
			<div class="page-toolbar">
				<div class="toolbar">
					<button id="create" class="btn btn-small btn-success" title="填写事故记录">
				...
				<div class="nav-search">
					<form id="search-form" class="form-search" onsubmit="return false;">
						<span class="input-icon">
							<input id="nav-search-input" name="search" type="text" placeholder="输入地点..." class="input-small nav-search-input" autocomplete="off">
				...
				<div class="span12">
					<form id="create-form" class="form-horizontal" onsubmit="return false;">
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea name="scheme" class="xheditor {skin:'nostyle',tools:'simple'}"></textarea>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">发生时间</label>
							<div class="controls">
								<input name="occurrenceTime" type="datetime">
							</div>
						</div>
					</form>
				</div>
	...
	<script type="text/javascript">
		seajs.use('${resources}/scripts/app/spmi/daily/accident/index');
	</script>
</body>
</html>
