...
<html>
<head>
<title>培训计划 - 山西王庄煤业数字矿山综合管理平台</title>
				...
				<div class="nav-search">
					<form id="search-form" class="form-search" onsubmit="return false;">
						<span class="input-icon">
							<input id="nav-search-input" name="search" type="text" placeholder="输入计划名称..." class="input-small nav-search-input" autocomplete="off">
