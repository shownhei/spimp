...
<body class="navbar-fixed">
				...
				<div class="span12">
					<form id="create-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="basicContent">内容</label>
							<div class="controls">
								<input id="create_basicContent" name="basicContent" type="text">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="addTime">更新时间</label>
							<div class="controls">
								<input id="create_addTime" name="addTime" type="text">
							</div>
						</div>
					</form>
				</div>
				...
				<div class="span12">
					<form id="edit-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="basicContent">内容</label>
							<div class="controls">
								<input id="edit_basicContent" name="basicContent" type="text">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="addTime">更新时间</label>
							<div class="controls">
								<input id="edit_addTime" name="addTime" type="text">
							</div>
						</div>
					</form>
				</div>
				...
				<div class="span12">
					<form id="detail-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="basicContent">内容</label>
							<div class="controls">
								<input id="detail_basicContent" name="basicContent" type="text" readonly="readonly">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="addTime">更新时间</label>
							<div class="controls">
								<input id="detail_addTime" name="addTime" type="text" readonly="readonly">
							</div>
						</div>
					</form>
				</div>
	...
	<script type="text/javascript">
		seajs.use('${resources}/scripts/app/spmi/document/basicinfomation/index');
	</script>
