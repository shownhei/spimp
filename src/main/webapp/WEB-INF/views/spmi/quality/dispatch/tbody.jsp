...
<tbody>
	...
	<tr>
		...
		<td>1.有线通信 矿井必须装备调度交换机，调度交换机应支持通过数字中继或通过IP语音网关实现联网功能，并应与上一级调度总机、矿区行政电话、井下移动通信等系统互联互通。 下井电话必须经过安全耦合器，电话机应是本质安全型。
			井下采掘工作面、变电所、上下山绞车房、主要水泵房、井底车场、运输调度站、带式输送机及中国控制硐室、永久避难硐室、井下水平和采取最高点、主要硐室等重要工作地点应设置调度电话。 地面矿领导值班室、科队值班室、地面变电站（所）、通风机房、瓦斯集中抽放站、主副井绞车房、水泵房、、井口急救站、小车队应设置调度电话</td>
	...
	<tr>
		...
		<td>无井下广播通信系统不得分；主机及广播端为设置在调度台扣0.5分；井下一处不能正常运行扣0.3分；一处人员集中位置未设置广播终端扣0.5分；音量不达标扣0.3分；在断电情况下连续播放不足2小时扣0.5分；其它功能缺失一项扣0.5分。 系统及广播终端不是本质安全型或不具有MA标志证书，不得分</td>
		<td align="center">2</td>
		<td></td>
		<td align="center"></td>
	</tr>
	...
	<tr>
		<td>5.工业视频系统 煤矿应装备工业视频系统，在井下主要胶带运输机头，盘区皮带转载点，井底车场、井下变电所、主副井井口、主通风机房、永久避难硐室等和井上主要工作场所如洗煤场、外运装车点、工业广场、办公楼等地点安装工业视频摄像头，并在调度大屏幕显示；图像储存时间应不小于7天，图像信号应能上传上一级调度室</td>
	...
	<tr>
		...
		<td>11.应用计算机处理日常报表 矿井要能够使用计算机处理日常报表：①生产日报；②旬、月汇报；③外运日报；④矿领导逐月带班下井统计表；⑤生产事故统计表；⑥采煤队工作面衔接情况表；⑦开掘队工作面衔接情况表；⑧初（末）次放顶及巷道贯通预报表；⑨达标规划、培训计划；⑩工作总结及专题汇报材料</td>
