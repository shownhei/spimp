...
<table class="grade-table" style="width: 843px; margin-top: 5px">
	...
	<tbody>
		<tr>
			<td>安全管理机构</td>
			<td colspan="2">
				<input name="collect-record-1-2" type="text" style="width: 540px; height: 100%; border: 0">
			</td>
		</tr>
		<tr>
			<td>安全人员配备</td>
		...
		<tr>
			<td rowspan="2">安全管理安全质量标准化评分必须具备的条件</td>
			<td>①矿井建立健全重大隐患排查和治理制度</td>
			<td>
				<input name="collect-record-9-3" type="text" style="width: 260px; height: 100%; border: 0">
			</td>
		</tr>
		<tr>
			<td>②按规定设置安全管理机构，人员配备能够满足安全生产需要</td>
			<td>
				<input name="collect-record-10-3" type="text" style="width: 260px; height: 100%; border: 0">
			</td>
		</tr>
	</tbody>
</table>