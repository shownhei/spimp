...
<body class="navbar-fixed">
					...
					<form id="create-form" class="form-horizontal" onsubmit="return false;">
						<table class="table-col-4">
							<tbody>
								...
								<tr>
									<td colspan="2">
										<label style="width: 100px">掘进工作面名称</label>
										<input name="name" type="text" style="width: 310px">
									</td>
									<td colspan="2">
										<label style="width: 100px">掘进方法</label>
							...
							<div class="span12">
								<table class="grade-table" style="width: 1020px; margin-top: 5px; margin-bottom: 2px">
									<thead>
										<tr>
											<th rowspan="3">序号</th>
											<th rowspan="3">掘进工作面名称</th>
											<th rowspan="3">掘进方法</th>
											<th colspan="7">小项得分</th>
											<th rowspan="2">总分</th>
										</tr>
										<tr>
											<th>集约生产</th>
	...
	<script type="text/javascript">
		seajs.use('${resources}/scripts/app/spmi/quality/tunnelling/index');
	</script>
</body>
</html>
