...
<body class="navbar-fixed">
			...
			<div class="page-toolbar">
				...
				<div class="nav-search">
					<form id="search-form" class="form-search" onsubmit="return false;">
						...
						<input name="search" type="text" style="height:15px;width:130px;font-size:12px;" placeholder="输入主题...">
				...
				<div class="span12">
					<form id="create-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							...
							<div class="controls">
								<input id="create_topic" name="topic" type="text">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="content">内容</label>
							<div class="controls">
							    <textarea id="create_content" name="content" style="width: 400px; height: 100px"></textarea>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="groupEntity">班组</label>
							<div class="controls">
								<input id="create_groupEntity" name="groupEntity" type="text" >
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="create_attachment" name="attachment" type="text">
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							<label class="control-label" for="participants">参与人员</label>
							<div class="controls">
								<input id="create_participants" name="participants" type="text">
							</div>
						</div>
					</form>
				</div>
				...
				<div class="span12">
					<form id="edit-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="topic">主题</label>
							<div class="controls">
								<input id="edit_topic" name="topic" type="text">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="content">内容</label>
						...
						<div class="control-group">
							<label class="control-label" for="groupEntity">班组</label>
							<div class="controls">
								<input id="edit_groupEntity" name="groupEntity" type="text">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="recordDate">日期</label>
						...
						<div class="control-group">
							<label class="control-label" for="participants">参与人员</label>
							<div class="controls">
								<input id="edit_participants" name="participants" type="text">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="remark">备注</label>
				...
				<div class="span12">
					<form id="detail-form" class="form-horizontal" style="margin-bottom: 0px;">
						<div class="control-group">
							<label class="control-label" for="topic">主题</label>
							<div class="controls">
								<input id="detail_topic" name="topic" type="text" readonly="readonly">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="content">内容</label>
						...
						<div class="control-group">
							<label class="control-label" for="groupEntity">班组</label>
							<div class="controls">
								<input id="detail_groupEntity" name="groupEntity" type="text" readonly="readonly">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="recordDate">日期</label>
						...
						<div class="control-group">
							<label class="control-label" for="participants">参与人员</label>
							<div class="controls">
								<input id="detail_participants" name="participants" type="text" readonly="readonly">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="remark">备注</label>
	...
	<script type="text/javascript">
		seajs.use('${resources}/scripts/app/teamculture/teamculture/index');
	</script>
